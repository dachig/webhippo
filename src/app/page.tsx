...
const perks = [
  ...
  },
  {
    name: "For The Planet",
    icon: Leaf,
    description: "1% of our sales go to the preservation and restoration of our natural environment."
  }
]
    ...
    <>
      <MaxWidthWrapper>
        <div className='py-20 mx-auto text-center flex flex-col items-center max-w-3xl'>
          <h1 className='text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl'>Your marketplace for high-quality <span className='text-orange-600'>digital assets</span>.</h1>
          <p className='mt-6 text-lg max-w-prose text-muted-foreground'>Welcome to WebHippo. Every asset on our
            platform is verified by out team to ensure our
